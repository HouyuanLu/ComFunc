...
def main():
    try:
        ...
        print("IMPORTANT FILE NOT FOUND...CANNOT PROCEED")
        input()
        sys.exit()

    if Info in "40.6126.23433.69456.39324.37264.59240.39747.32293.49471.21983.49432.00273." \
               "34742.39493.10202.00853.48342.39238.39414":
        pass
    else:
        print("IMPORTANT FILE CORRUPTED...CANNOT PROCEED")
        input()
        sys.exit()
                        ...
                        if Choice1 in ("0", "1", "2"):
                            ...
                            if Choice1 in "1":
                                ...
                                while True:
                                    ...
                                    Guess = float(
                                        input("I Am Thinking Of A Number! Guess The Number I Am Thinking Of: "))
